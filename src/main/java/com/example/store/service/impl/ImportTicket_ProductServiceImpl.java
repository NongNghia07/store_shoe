...
public class ImportTicket_ProductServiceImpl implements ImportTicket_ProductService {
    ...
    @Autowired
    public ImportTicket_ProductServiceImpl(ImportTicketProductRepository importTicketProductRepository, ModelMapper modelMapper, ProductService productService, Product_VariantService productVariantService) {
